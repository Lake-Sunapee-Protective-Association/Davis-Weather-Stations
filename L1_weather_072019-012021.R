...
weather_L0 <- read.csv(file.path(datadir, 'L0 data/davis_weather_data_2019-2022_L0_2022-03-09.csv')) %>% 
  mutate(instrument_datetime = as.POSIXct(instrument_datetime, tz = 'America/New_York'),
         datetime_noDST = as.POSIXct(instrument_datetime, tz = 'Etc/GMT+5'),
...
HC_timechange <- HC_timechange %>% 
  mutate(datetime_noDST = case_when(datetime_noDST >= as.POSIXct('2020-05-15 18:30', tz = 'Etc/GMT+5') ~ datetime_noDST + hours(1),
                                    TRUE ~ datetime_noDST)) %>% 
  mutate(time_flag = case_when(datetime_noDST >= as.POSIXct('2020-05-15 18:30', tz = 'Etc/GMT+5') ~ 'm: +4h',
                               TRUE ~ time_flag))
...
HC_timechange <- HC_timechange %>% 
  mutate(datetime_noDST = case_when(datetime_noDST >= as.POSIXct('2020-06-24 17:00', tz = 'Etc/GMT+5') ~ datetime_noDST + hours(22) + minutes(30),
                                    TRUE ~ datetime_noDST)) %>% 
  mutate(time_flag = case_when(datetime_noDST >= as.POSIXct('2020-06-24 17:00', tz = 'Etc/GMT+5') ~ 'm: +26.5h',
                               TRUE ~ time_flag))
...
HC_timechange <- HC_timechange %>% 
  mutate(datetime_noDST = case_when(datetime_noDST >= as.POSIXct('2020-07-10 10:30', tz = 'Etc/GMT+5') ~ datetime_noDST + days(10) + hours(7),
                                    TRUE ~ datetime_noDST)) %>% 
  mutate(time_flag = case_when(datetime_noDST >= as.POSIXct('2020-07-10 10:30', tz = 'Etc/GMT+5') ~ 'm: +11d 9.5h',
                               TRUE ~ time_flag))
...
HC_timechange <- HC_timechange %>% 
  mutate(datetime_noDST = case_when(datetime_noDST >= as.POSIXct('2020-08-16 3:00', tz = 'Etc/GMT+5') ~ datetime_noDST - days(11) - hours(9) - minutes(30),
                                    TRUE ~ datetime_noDST)) %>% 
...
HC_timechange <- HC_timechange %>% 
  mutate(datetime_noDST = case_when(datetime_noDST >= as.POSIXct('2020-09-06 11:30', tz = 'Etc/GMT+5') ~ datetime_noDST + hours(1),
                                    TRUE ~ datetime_noDST)) %>% 
  mutate(time_flag = case_when(datetime_noDST >= as.POSIXct('2020-09-06 11:30', tz = 'Etc/GMT+5') ~ 'm: +1h',
                               TRUE ~ time_flag))
...
ix=which(weather_L1$location == 'GM' & weather_L1$datetime_noDST<as.POSIXct('2019-07-10 9:30', tz='Etc/GMT+5'))
...
ix=which(weather_L1$location == 'SF' & weather_L1$datetime_noDST<as.POSIXct('2019-07-09 05:00', tz='Etc/GMT+5'))
