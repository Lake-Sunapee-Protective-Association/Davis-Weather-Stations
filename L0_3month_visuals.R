...
start <- as.POSIXct('2021-10-01', tz = 'America/New_York')
end <-  as.POSIXct('2022-01-01', tz = 'America/New_York')
...
## 2021-10-01 ####
dump_dir = ('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/weather/LSPA_Davis_stations/graphs/L0/2021-10-01 download/')

#edit dates as necessary
start <- as.POSIXct('2021-07-01', tz = 'America/New_York')
end <-  as.POSIXct('2021-10-01', tz = 'America/New_York')
...
## 2021-07-01 ####
dump_dir = ('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/weather/LSPA_Davis_stations/graphs/L0/2021-07-01 download/')

#edit dates as necessary
start <- as.POSIXct('2021-04-01', tz = 'America/New_York')
end <-  as.POSIXct('2021-07-01', tz = 'America/New_York')
...
## 2021-04-01 ####
dump_dir = ('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/weather/LSPA_Davis_stations/graphs/L0/2021-04-01 download/')

#edit dates as necessary
start <- as.POSIXct('2021-01-01', tz = 'America/New_York')
end <-  as.POSIXct('2021-04-01', tz = 'America/New_York')
...
## 2021-01-01 ####
dump_dir = ('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/weather/LSPA_Davis_stations/graphs/L0/2021-01-01 download/')

#edit dates as necessary
start <- as.POSIXct('2020-10-01', tz = 'America/New_York')
end <-  as.POSIXct('2021-01-01', tz = 'America/New_York')
...
## 2020-10-01 ####
dump_dir = ('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/weather/LSPA_Davis_stations/graphs/L0/2020-10-01 download/')

#edit dates as necessary
start <- as.POSIXct('2020-07-01', tz = 'America/New_York')
end <-  as.POSIXct('2020-10-01', tz = 'America/New_York')
...
## 2020-07-01 ####
dump_dir = ('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/weather/LSPA_Davis_stations/graphs/L0/2020-07-01 download/')

#edit dates as necessary
start <- as.POSIXct('2020-04-01', tz = 'America/New_York')
end <-  as.POSIXct('2020-07-01', tz = 'America/New_York')
...
## 2020-04-01 ####
dump_dir = ('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/weather/LSPA_Davis_stations/graphs/L0/2020-04-01 download/')

#edit dates as necessary
start <- as.POSIXct('2020-01-01', tz = 'America/New_York')
end <-  as.POSIXct('2020-04-01', tz = 'America/New_York')
...
## 2020-01-01 ####
dump_dir = ('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/weather/LSPA_Davis_stations/graphs/L0/2020-01-01 download/')

#edit dates as necessary
start <- as.POSIXct('2019-10-01', tz = 'America/New_York')
end <-  as.POSIXct('2020-01-01', tz = 'America/New_York')
...
## 2019-10-01 ####
dump_dir = ('C:/Users/steeleb/Dropbox/Lake Sunapee/monitoring/weather/LSPA_Davis_stations/graphs/L0/2019-10-01 download/')

#edit dates as necessary
start <- as.POSIXct('2019-07-01', tz = 'America/New_York')
end <-  as.POSIXct('2019-10-01', tz = 'America/New_York')
