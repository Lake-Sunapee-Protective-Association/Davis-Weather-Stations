...
dir = 'C:/Users/steeleb/Dropbox/EDI_submissions/sunapee_davisweather_2019-2023_vJan2024/'
...
template_table_attributes(
  ...
  data.table = c('davis_weather_data_GeorgesMills_07-2019_01-2024_L1ODM2_v2024-01-02.csv', #what the data tables are called
                 'davis_weather_data_HerrickCove_07-2019_01-2024_L1ODM2_v2024-01-02.csv',
                 'davis_weather_data_SouthOfTheFells_07-2019_01-2024_L1ODM2_v2024-01-02.csv',
...
```{r}
attr_GM <- read.table(
  file = paste0(dir, 'attributes_davis_weather_data_GeorgesMills_07-2019_01-2024_L1ODM2_v2024-01-02.txt'),
  header = TRUE,
  sep = '\t',
  quote = "\"",
  as.is = TRUE,
...
attr_GM <- attr_GM %>% 
  mutate(unit = case_when(grepl('degC', attributeName, ignore.case = T) ~ 'celsius',
                          ...
                          grepl('mmphr', attributeName, ignore.case = T) ~ 'millimeterPerHour',
                          ...
                          grepl('Day', attributeName, ignore.case = T) ~ 'degreeDay',
                          grepl('index', attributeName, ignore.case = T) ~ 'dimensionless',
                          TRUE ~ ''),
         attributeDefinition = case_when(attributeName == 'datetime_noDST' ~ 'date and time (GMT -5) of buoy record - no daylight savings observed',
                                         ...
                                         attributeName == 'rain_flag' ~ 'flag for variable precipitation_mm and rainfallRate_mmphr',
         ...
         dateTimeFormatString = case_when(attributeName == 'datetime_noDST' ~ 'YYYY-MM-DD hh:mm:ss',
                                          attributeName == 'instrument_datetime' ~ 'YYYY-MM-DD hh:mm:ss'),
         missingValueCode = 'NA',
         ...
         class = case_when(attributeName == 'rain_flag' ~ 'categorical', #no flags
                           attributeName == 'time_flag' ~ 'categorical', #no flags
                           attributeName == 'BP_flag' ~ 'categorical', #no flags
                           attributeName == 'SR_flag' ~ 'categorical', #no flags
                           attributeName == 'UV_flag' ~ 'categorical', #no flags
...
```{r}
attr_HC <- read.table(
  file = paste0(dir, 'attributes_davis_weather_data_HerrickCove_07-2019_01-2024_L1ODM2_v2024-01-02.txt'),
  header = TRUE,
  sep = '\t',
  quote = "\"",
  as.is = TRUE,
...
attr_HC <- attr_HC %>% 
  mutate(unit = case_when(grepl('degC', attributeName, ignore.case = T) ~ 'celsius',
         ...
         missingValueCodeExplanation = case_when(grepl('NA', missingValueCode, ignore.case = T) ~ 'not available',
                                                 TRUE ~ missingValueCodeExplanation),
         class = case_when(attributeName == 'time_flag' ~ 'categorical', 
                           attributeName == 'BP_flag' ~ 'categorical', #no flags
                           attributeName == 'SR_flag' ~ 'categorical', #no flags
                           attributeName == 'UV_flag' ~ 'categorical', #no flags
                           attributeName == 'rain_flag' ~ 'categorical', 
                           attributeName == 'heatingDegreeDays' ~ 'numeric',
                           attributeName == 'coolingDegreeDays' ~ 'numeric',
                           attributeName == 'source' ~ 'character',
                           TRUE ~ class))
...
#### QAQC'd South of the Fells data using ODM2 CV

First, read into R, and make sure it looks okay
```{r}
attr_SF <- read.table(
  file = paste0(dir, 'attributes_davis_weather_data_SouthOfTheFells_07-2019_01-2024_L1ODM2_v2024-01-02.txt'),
  header = TRUE,
  sep = '\t',
  quote = "\"",
  as.is = TRUE,
...
attr_SF <- attr_SF %>% 
  mutate(unit = case_when(grepl('degC', attributeName, ignore.case = T) ~ 'celsius',
         ...
         missingValueCodeExplanation = case_when(grepl('NA', missingValueCode, ignore.case = T) ~ 'not available',
                                                 TRUE ~ missingValueCodeExplanation),
         class = case_when(attributeName == 'time_flag' ~ 'categorical', #no flags
                           attributeName == 'rain_flag' ~ 'categorical', #no flags
                           attributeName == 'BP_flag' ~ 'categorical', #no flags
                           attributeName == 'SR_flag' ~ 'categorical', #no flags
                           attributeName == 'UV_flag' ~ 'categorical', #no flags
                           attributeName == 'heatingDegreeDays' ~ 'numeric',
...
```{r}
attr_loc <- attr_loc %>% 
  mutate(unit = case_when(grepl('tude', attributeName, ignore.case = T) ~ 'decimalDegree',
         ...
         dateTimeFormatString = case_when(attributeName == 'DateDeployed' ~ 'YYYY-MM-DD hh:mm:ss'),
         missingValueCode = case_when(attributeName == 'WaterDepthMeters' ~ 'NA',
                                      TRUE ~ NA_character_),
         missingValueCodeExplanation = case_when(grepl('NA', missingValueCode, ignore.case = T) ~ 'not available',
                                                 is.na(missingValueCode) ~ 'not available',
                                                 TRUE ~ missingValueCodeExplanation),
...
custom_units <- custom_units %>% 
  ...
  add_row(id = 'millimeterPerHour',
            unitType = 'speed',
            parentSI = '',
            multiplierToSI = '',
            description = 'expression of rate in millimeter per hour')
...
catvars_data <- read.table(
  file = paste0(dir, 'catvars_davis_weather_data_GeorgesMills_07-2019_01-2024_L1ODM2_v2024-01-02.txt'),
  header = TRUE,
  sep = '\t',
  quote = "\"",
  as.is = TRUE,
...
```{r}
catvars_data <- read.table(
  file = paste0(dir, 'catvars_davis_weather_data_HerrickCove_07-2019_01-2024_L1ODM2_v2024-01-02.txt'),
  header = TRUE,
  sep = '\t',
  quote = "\"",
  as.is = TRUE,
...
```{r}
catvars_data <- catvars_data %>% 
  mutate(definition = case_when(code == 'pine needle removed from rain gauge; data prior may not be precise due to clogged gauge' ~ 'use with caution; pine needle removed from rain gauge; data prior may not be precise due to clogged gauge',
                                grepl("clogged rain", code) ~ 'use with caution; clogged rain gauge suspected',
                                ...
                                code == 'oAM; i' ~ 'sensor is obscured in the morning, use with caution; data reporting intermittently',
                                code == 'oAM; s' ~ 'sensor is obscured in the morning, use with caution; data suspect, use with caution',
                                code == 'l' ~ 'barometric pressure is lower than other 2 stations, use with caution',
                                code == 'N' ~ 'north',
                                code == 'NNE' ~ 'north north east',
                                code == 'NE' ~ 'north east',
                                code == 'ENE' ~ 'east north east',
                                ...
                                code == 'HC' ~ 'Herrick Cove',
                                code == 'SF' ~ 'South Fells',
                                code == 'm: +11d 9h' ~ 'time has been adjusted from instrument_time by 11 days and 9 hours, time is approximate',
                                code == 'm: +11h' ~ 'time has been adjusted from instrument_time by 11 hours, time is approximate',
                                code == 'm: +12.5' ~ 'time has been adjusted from instrument_time by 12.5 hours, time is approximate',
                                code == 'm: +12h' ~ 'time has been adjusted from instrument_time by 12 hours, time is approximate',
                                (code == 'm: +13h'| code == 'm: +13') ~ 'time has been adjusted from instrument_time by 13 hours, time is approximate',
                                code == 'm: +13.5' ~ 'time has been adjusted from instrument_time by 13.5 hours, time is approximate',
                                (code == 'm: +14.5h'| code == 'm: +14.5') ~ 'time has been adjusted from instrument_time by 14.5 hours, time is approximate',
                                code == 'm: +15' ~ 'time has been adjusted from instrument_time by 15 hours, time is approximate',
                                code == 'm: +16' ~ 'time has been adjusted from instrument_time by 16 hours, time is approximate',
                                code == 'm: +1h' ~ 'time has been adjusted from instrument_time by 1 hour, time is approximate',
                                code == 'm: +2.5h' ~ 'time has been adjusted from instrument_time by 2.5 hours, time is approximate',
                                code == 'm: +25' ~ 'time has been adjusted from instrument_time by 25 hours, time is approximate',
                                code == 'm: +26' ~ 'time has been adjusted from instrument_time by 26 hours, time is approximate',
                                (code == 'm: +26.5'| code == 'm: +26.5h') ~ 'time has been adjusted from instrument_time by 26.5 hours, time is approximate',
                                code == 'm: +27' ~ 'time has been adjusted from instrument_time by 27 hours, time is approximate',
                                code == 'm: +27.5' ~ 'time has been adjusted from instrument_time by 27.5 hours, time is approximate',
                                code == 'm: +28.5' ~ 'time has been adjusted from instrument_time by 28.5 hours, time is approximate',
                                code == 'm: +29' ~ 'time has been adjusted from instrument_time by 29 hours, time is approximate',
                                code == 'm: +29.5' ~ 'time has been adjusted from instrument_time by 29.5 hours, time is approximate',
                                code == 'm: +2h' ~ 'time has been adjusted from instrument_time by 2 hours, time is approximate',
                                code == 'm: +3.5h' ~ 'time has been adjusted from instrument_time by 3.5 hours, time is approximate',
                                code == 'm: +3h' ~ 'time has been adjusted from instrument_time by 3 hours, time is approximate',
                                code == 'm: +4.5h' ~ 'time has been adjusted from instrument_time by 4.5 hours, time is approximate',
                                code == 'm: +5h' ~ 'time has been adjusted from instrument_time by 5 hours, time is approximate',
                                TRUE ~ ''))
catvars_data
```
...
```{r}
catvars_data <- read.table(
  file = paste0(dir, 'catvars_davis_weather_data_SouthOfTheFells_07-2019_01-2024_L1ODM2_v2024-01-02.txt'),
  header = TRUE,
  sep = '\t',
  quote = "\"",
  as.is = TRUE,
...
make_eml(
  path = dir,
    data.path = paste0(dir, 'data/'),
  eml.path = dir,
  dataset.title = 'Weather station data from three locations at Lake Sunapee (NH, USA), July 2019 – December 2023',
  ...
  temporal.coverage = c('2019-07-01', '2023-12-31'),
  maintenance.description = 'ongoing',
  data.table = c('davis_weather_data_GeorgesMills_07-2019_01-2024_L1ODM2_v2024-01-02.csv',
                 'davis_weather_data_HerrickCove_07-2019_01-2024_L1ODM2_v2024-01-02.csv',
                 'davis_weather_data_SouthOfTheFells_07-2019_01-2024_L1ODM2_v2024-01-02.csv',
                 'weather_station_location.csv'),
